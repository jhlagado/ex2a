...
export default class TranslucentBarExample extends React.PureComponent {
  static route = {
    navigationBar: {
      ...
      <View style={styles.container}>
        ...
        <TabNavigation
          ...
          <TabNavigationItem
            ...
            <Image source={require('../assets/images/colorful-windows.jpg')} style={styles.image} />
          </TabNavigationItem>
          <TabNavigationItem
            id="second"
            title="Second"
            ...
            <Image source={require('../assets/images/beetle.jpg')} style={styles.image} />
          </TabNavigationItem>
          <TabNavigationItem
            id="third"
            title="Third"
            ...
            <Image source={require('../assets/images/paintbrush.jpg')} style={styles.image} />
          </TabNavigationItem>
        </TabNavigation>
      </View>
    );
