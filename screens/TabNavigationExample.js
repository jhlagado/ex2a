...
export default class TabNavigationExample extends React.PureComponent {
  static route = {
    navigationBar: {
        ...
        <TabNavigation
          ...
          <TabNavigationItem
            ...
            <View style={styles.row}>
              <Image style={styles.image} source={require('../assets/images/beetle.jpg')} />
              <Image style={styles.image} source={require('../assets/images/colorful-windows.jpg')} />
              <Image style={styles.image} source={require('../assets/images/paintbrush.jpg')} />
              <Image style={styles.image} source={require('../assets/images/sparkles.jpg')} />
            </View>
          </TabNavigationItem>
          <TabNavigationItem
            id="second"
            ...
            <Image style={styles.gif} source={require('../assets/images/cat.gif')} />
          </TabNavigationItem>
          <TabNavigationItem
            id="third"
            title="Third"
